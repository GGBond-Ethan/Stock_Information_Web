...
alter table topic_stock_relations enable row level security;
alter table event_stock_relations enable row level security;
...
create policy "public read hot topics" on hot_topics for select using (true);
create policy "public read market events" on market_events for select using (true);
create policy "public read topic stock relations" on topic_stock_relations for select using (true);
create policy "public read event stock relations" on event_stock_relations for select using (true);
